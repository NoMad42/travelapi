...
class AdminTourTest extends TestCase
{
    ...
    public function test_saves_tour_successfully_with_valid_date(): void
    {
        $this->seed(RoleSeeder::class);
        $user = User::factory()->create();
        ...
        $endpointUri = '/api/v1/admin/travels/'.$travel->slug.'/tours';

        $response = $this->actingAs($user)->postJson($endpointUri, [
            'name' => 'Tour name',
        ]);
        ...
        $response = $this->get(Str::remove('/admin', $endpointUri));
